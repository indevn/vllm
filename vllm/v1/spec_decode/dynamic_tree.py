...
def verify_dynamic_tree_greedy_kernel(
    ...
    *,
    ...
    from vllm.v1.spec_decode.dynamic_tree_verify import (
        verify_dynamic_tree_greedy_kernel as _verify_dynamic_tree_greedy_kernel,
    )

    return _verify_dynamic_tree_greedy_kernel(
        candidates,
        retrieve_index,
        retrieve_next_token,
        retrieve_next_sibling,
...
def verify_dynamic_tree_greedy_from_draft(
    ...
    *,
    ...
    from vllm.v1.spec_decode.dynamic_tree_verify import (
        verify_dynamic_tree_greedy_from_draft as _verify_dynamic_tree_greedy_from_draft,
    )

    return _verify_dynamic_tree_greedy_from_draft(
        draft_tree,
        target_predict,
        tree_valid=tree_valid,
    )
...
def verify_dynamic_tree_greedy(
    ...
    *,
    ...
    from vllm.v1.spec_decode.dynamic_tree_verify import (
        verify_dynamic_tree_greedy as _verify_dynamic_tree_greedy,
    )

    return _verify_dynamic_tree_greedy(
        candidates,
        retrieve_index,
        retrieve_next_token,
        retrieve_next_sibling,
